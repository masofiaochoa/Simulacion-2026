# no es basura. es el tp de unos compañeros del año pasado
# difiere en que el año pasado se requeria contar colores, ademas de que este es basicamente el tp1.2
# lo dejo por si a alguien le sirve de claridad para seguir desarrollando el tp1.1
...
# Inicio del programa
if len(sys.argv) != 11:
    print("Uso: python Tp1.2-Estrategias.py -c <cant_tiradas> -n <corridas> -e <color_elegido>")
    sys.exit(1)
